    ...
    async def call_tool(
        ...
        if tool is not None and isinstance(arguments, dict):
            ...
            if unknown and known:
                ...
                # spelled the same list out, so fs_query's refusal shipped its
                # ten parameter names twice -- 241 characters where 120 say the
                # same thing, on a server whose whole point is a tight context.
